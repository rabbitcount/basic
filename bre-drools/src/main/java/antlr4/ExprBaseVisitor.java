package antlr4;// Generated from Expr.g4 by ANTLR 4.5.1
...
public class ExprBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements ExprVisitor<T> {
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    public T visitBlank(ExprParser.BlankContext ctx) {
        return visitChildren(ctx);
    }
     ...
     * {@link #visitChildren} on {@code ctx}.</p>
     */
    public T visitParents(ExprParser.ParentsContext ctx) {
        return visitChildren(ctx);
    }
}